...
function X() {
  ...
  var j = Array.isArray, O = Object.prototype.hasOwnProperty, S = { current: null }, g = { key: !0, ref: !0, __self: !0, __source: !0 };
  function P(e, t, n) {
    var o, u = {}, c = null, s = null;
    if (t != null) for (o in t.ref !== void 0 && (s = t.ref), t.key !== void 0 && (c = "" + t.key), t) O.call(t, o) && !g.hasOwnProperty(o) && (u[o] = t[o]);
  ...
  function d(e, t, n, o, u) {
    ...
    if (s) return s = e, u = u(s), e = o === "" ? "." + E(s, 0) : o, j(u) ? (n = "", e != null && (n = e.replace(I, "$&/") + "/"), d(u, t, n, "", function(a) {
      return a;
    })) : u != null && (R(u) && (u = G(u, n + (!u.key || s && s.key === u.key ? "" : ("" + u.key).replace(I, "$&/") + "/") + e)), t.push(u)), 1;
    if (s = 0, o = o === "" ? "." : o + ":", j(e)) for (var f = 0; f < e.length; f++) {
      c = e[f];
      var i = o + E(c, f);
      s += d(c, t, n, i, u);
    }
    else if (i = W(e), typeof i == "function") for (e = i.call(e), f = 0; !(c = e.next()).done; ) c = c.value, i = o + E(c, f++), s += d(c, t, n, i, u);
  ...
  var l = { current: null }, h = { transition: null }, Q = { ReactCurrentDispatcher: l, ReactCurrentBatchConfig: h, ReactCurrentOwner: S };
  function q() {
  ...
  return r.Children = { map: _, forEach: function(e, t, n) {
    ...
    return e;
  } }, r.Component = p, r.Fragment = D, r.Profiler = F, r.PureComponent = v, r.StrictMode = U, r.Suspense = z, r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Q, r.act = q, r.cloneElement = function(e, t, n) {
    if (e == null) throw Error("React.cloneElement(...): The argument must be a React element, but you passed " + e + ".");
    var o = b({}, e.props), u = e.key, c = e.ref, s = e._owner;
    if (t != null) {
    ...
    return e = { $$typeof: M, _currentValue: e, _currentValue2: e, _threadCount: 0, Provider: null, Consumer: null, _defaultValue: null, _globalName: null }, e.Provider = { $$typeof: L, _context: e }, e.Consumer = e;
  }, r.createElement = P, r.createFactory = function(e) {
    var t = P.bind(null, e);
    return t.type = e, t;
